                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {client.phone && (
                              <button
                                  ...
                                  className="inline-flex items-center gap-1.5 px-3 py-2 border border-success/30 text-xs font-medium rounded-lg text-success bg-background hover:bg-success/5 transition-all duration-200 shadow-sm hover:shadow-md"
                              >
                      ...
                      <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center gap-3">
                        <button
                          ...
                          className="flex-1 inline-flex items-center justify-center px-4 py-2.5 border border-border shadow-sm text-sm font-medium rounded-lg text-foreground bg-background hover:bg-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring transition-all duration-200"
                        >
                        ...
                        <button
                          ...
                          className="flex-1 inline-flex items-center justify-center px-4 py-2.5 border border-destructive/30 shadow-sm text-sm font-medium rounded-lg text-destructive bg-background hover:bg-destructive/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-destructive transition-all duration-200"
                        >
                  ...
                  return (
                    <div key={client.id} className="bg-card text-foreground overflow-hidden p-4 rounded-lg shadow-sm border border-border flex flex-col">
                        ...
                        <div className="flex justify-between items-start">
                            ...
                            {client.phone && (
                                <button
                                    onClick={() => sendWhatsAppMessage(client)}
                                    title="Enviar mensagem no WhatsApp"
                                    className="flex-shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1 border border-success/30 text-xs font-medium rounded-md text-success bg-background hover:bg-success/5 transition-colors"
                                >
                                    <FaWhatsapp className="w-4 h-4" />
                                    <span>Wpp</span>
                                </button>
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100 flex items-center gap-2">
                        <button
                          onClick={() => handleEditClient(client)}
                          className="flex-1 inline-flex items-center justify-center px-3 py-1.5 border border-border text-xs font-medium rounded-md text-foreground bg-background hover:bg-accent"
                        >
                        ...
                        <button
                          onClick={() => handleDeleteClick(client)}
                          className="flex-1 inline-flex items-center justify-center px-3 py-1.5 border border-destructive/30 text-xs font-medium rounded-md text-destructive bg-background hover:bg-destructive/5"
                        >
